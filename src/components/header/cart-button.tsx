...
const CartButton: FC = () => {
  ...
  return (
    <Link
      href="/cart"
      className="relative flex h-10 w-10 items-center justify-center rounded-full border-2 border-slate-400/40 text-slate-500 hover:border-purple-400/30 hover:bg-purple-900/40 hover:text-purple-400"
    >
